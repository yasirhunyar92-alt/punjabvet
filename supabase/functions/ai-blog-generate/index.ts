...
Return ONLY this JSON shape (no extra text):
{
  ...
  "excerpt": "English excerpt 140-160 chars summarizing the post",
  "excerpt_ur": "Urdu excerpt",
  "content": "Full English article 600-900 words using markdown headings (##) and bullet points",
  "content_ur": "Full Urdu translation",
  "seo_title": "SEO title <=60 chars with keyword",

        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-card rounded-xl overflow-hidden border shadow-sm">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27182.82!2d72.539!3d31.825!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3922d7c5e8e!2sSillanwali!5e0!3m2!1sen!2spk!4v1700000000"
                width="100%" height="250" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"
                title="Punjab Vet Location Sillanwali"
              />
            </div>
          </div>
